...
.slow(8).late(0.035).late(suinge).transpose(36).midi(mb1).midichan(1)
...
$sn: note("<~ 3(< 17 9 36 27>,36)>").late(0.037).late(suinge).transpose(36).midi(mb1).midichan(4)

$keys: note("[0 5 18  28]*18").struct("1(<13 15>,18)").transpose("2 2 3 0 4 2 4 3 3 1 0 0 3 2 0 0 4 1 2 2 4 1 2 4 3 3 2 2 4 1 4 0 0 2 3 4 2 4 4 4 1 0 0 3 1 0 3 1 0 0 3 3 0 0 3 4 0 0 1 4 4 3 4 2 2 4 1 4 0 4 2 1 1 1 4 0 4 2 1 3 4 4 4 3 1 2 0 3 2 0 2 4 4 2 1 2 0 0 4 4 1 1 1 3 0 0 4 3 3 4 2 2 4 0 3 4 1 2 2 4 3 1 1 1 4 4 3 1 4 1 1 3 3 0 1 1 3 3 2 4 4 1 2 0".slow(8))
    .gain("[1.2 0.8 0.7 0.6  0.7 1.1]*3*8".mul(0.9))
  .legato(perlin.range(1,2).ribbon(23,9)).late(0.037).late(suinge).transpose(0).transpose(31).transpose(60).midi(mb1).midichan(5)

$chords1: note("[0,5,18,29]").transpose(60).transpose(6).transpose(13).midi(mb1).midichan(7)

$chords1: note("[0,18,23, 26]").transpose(60).transpose(6).transpose(13).midi(mb1).midichan(7)

$chords: note("[0 5 18 29]*6").mask("<1(15,18,1) 0>").transpose(60).transpose(-62).transpose("0 31 [62 52] 31").transpose(6).transpose(13).midi(mb1).midichan(6)
