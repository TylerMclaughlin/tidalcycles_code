...
synth1:note(irand(31).ribbon("<0 5 0 <7>>",0.5).add(48).seg("<16>").struct("1(<13 11>,18)")
  .quantizeBy(31, "0:13:18:23:28 "))
...
synth2:note(irand(31).ribbon("<0 5 0 <7 12>>",0.5).add(53).seg("<8>")
  .struct("1(<13 11>,18)").quantizeBy(31, "0:5:10:13:18:23:28 ")).late(0.001)
  .gain(irand(33).div(33).ribbon(23,1).seg(13))
  .legato("5").midi(mb).midichan(2)._punchcard()
aoc:note("[0 1 2 3  ~ ~ ~ ~]/8").transpose(36).midi(mb).midichan(9) 

bass:note("<18 23 31 18  13 5 18 31>".add(31).gain("<0.5!5 0.2 0.5!2>").quantizeBy(31, "0:5:10:13:18:23:28 "))
  .midi(mb).midichan(7)
...
ch: note("[6 <~ 6> ~ ~] ~ [6 5 6 6] [5 6 <5 ~> 5]".sub(2))
  .slow(1).gain("[<0.6 0.5>  0.4 0.2 <0.5 0.2>]*4".mul(1.4))
  .transpose(36).midi(mb).midichan(6)
  .late("0.88".div(18)).late("[0 0.0015 0.0002 0.0023]*4".add(irand(30).seg(16).mul(0.00003)))
