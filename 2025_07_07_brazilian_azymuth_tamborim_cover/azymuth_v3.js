setCpm(107/2)
 // "Tamborim, cuica, ganza, berimbau" Azymuth (1977)

const m1 = 'IAC Driver Bus 1'

let suinge = "[0 0.005 -0.0115 -0.0195]*2",
    ss = "0.02"
...
.legato("<0.38 1> 0.6@3 0.7@4")
.gain("<0.25 1> 0.55@3 1@4")
  .late(ss.mul(0.35)).late(suinge.mul(0.35)).late(0.001)
...
$drumz: stack(
  note("5!8").gain("1.1 0.5 0.55 0.9"
            .mul("0.9").fast(2)).legato(0.8),
  note("4(5,8) [4 4 ~ ~]".slow(2))
            .gain("1 [0.6 1] [1 0.6] 1@5".slow(2)),
...
$melody: note(`~@5 11 ~ 12 11 12 ~ 11 ~ 9  ~  
               ...
               ~  11 ~ 12 11 12 ~ 11 ~ 12  ~  
               16 ~ ~  14  16  14@5  ~@7`)
  .late("0!15 0.001@4  0!45").slow(8)
  .late(ss).late(suinge)
  .transpose(72).midi(m1).midichan(4)

$melody: note(`2 ~ ~ -1  2 2 -1  2 2 -1  2 2 -1  2
               ~ 4@3 4@3 4@2 4@3 7@3 4@3 
               -1 ~ ~ -3  -1 -1 -3  -1 -1 -3  -1 -1 -3  -1
               ~ 2@3 2@3 2@2 0@3 0@3 0@3 `)
  .gain(`[1.1@3 0.5 0.8 0.5@2 0.8 0.5@2 0.8 0.5@2 0.8
          ~ 1.2@3 0.5@5 1@3 0.5@6]*2`)
  .slow(8).late(ss.mul(0.8)).late(suinge.mul(0.8))
  .transpose(72).midi(m1).midichan(4)


$keys: note(`[[3,7,9,14]@6 [[7,8,12,16]@4 
             [8,12,16,19] [8,12,16]]@10 
  ...
  .legato(1).late(ss.mul(0.4)).late(suinge.mul(0.4))
